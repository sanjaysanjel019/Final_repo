<template>
  ...
  <div class="row">
    <div class="col" id="column1" style="margin-left: -170px;">
      <h2>WELCOME #DRIVER'S NAME</h2><br>
      <button class="button" style="margin-top:40px; margin-right:70px;">PICK-UP TIME</button>
      <input type="datetime-local" name="" id="dateTimeLocal1"/><br>
      <button class="button" style="margin-top:10px; margin-right:70px;">DROP-OFF TIME</button>
    ...
    <div style="margin-top: 130px;text-align: center;">
      ...
      <div>
        <input type="file" style="background-color: #fff; padding-top: 3px; padding-left: 3px;padding-down: 4px;justify-content: center;" id="myfile" name="myfile">
        </div> 
