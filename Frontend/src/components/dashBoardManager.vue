<template>
 ...
 <div class="container-com">
   ...
   <div class="two">
    <div class="three">
      <span class = "two1" style="color: #fff; font-size: 22px; font-weight: bold;">WELCOME KEANU REEVES</span> 
    
    
      <img src="../assets/logo.png" style="width=310px; height=250px; justify-content: center; margin-top: 60px;"/>
    </div>
   </div>
